...
test('the shorthand hint is one-time, dismissible, reduced-motion safe, and shared by the app', () => {
  ...
  assert.match(appSource, /<NumberSuffixHint[\s\S]*amount=\{game\.light\}[\s\S]*suppressed=\{utilityPanelOpen \|\| storyModalActive \|\| resetPreviewOpen \|\| universeInstrumentActive\}/)
