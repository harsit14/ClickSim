...
Status: **current desktop release gate**
...
| Translation extraction | The build emits `dist/i18n/en.json` from live content definitions. The current catalog contains 2,425 stable keys spanning every universe, Guide, Atlas, Garden, and release shell. |
