...
<style>
  ...
  .summit-range { --heart-aperture:clamp(5.2rem,8vw,6.6rem);left:50%;bottom:8%;width:min(70vw,62rem);height:66%;transform:translateX(-50%);clip-path:polygon(0 100%,18% 72%,31% 78%,50% 8%,69% 77%,82% 65%,100% 100%);background:linear-gradient(145deg,color-mix(in srgb,var(--gold) 14%,#28465b),#0a1624 55%,#04080e);-webkit-mask:radial-gradient(circle var(--heart-aperture) at 50% 54.5%,transparent 0 82%,rgba(0,0,0,.28) 86%,#000 100%);mask:radial-gradient(circle var(--heart-aperture) at 50% 54.5%,transparent 0 82%,rgba(0,0,0,.28) 86%,#000 100%);filter:drop-shadow(0 0 1.6rem color-mix(in srgb,var(--gold) 8%,transparent)); }
  ...
  .summit-rest { left:50%;top:51%;width:3.6rem;height:1.4rem;transform:translate(-50%,-50%);border:0;border-top:1px dashed color-mix(in srgb,white 46%,transparent);border-radius:50%;background:transparent;box-shadow:none; }
