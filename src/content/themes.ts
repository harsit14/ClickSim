...
export const THEMES: ThemeDef[] = [
  {
    ...
    universeVars: {
      ...
      brahmalok: { '--amber': '#d7a34c', '--gold': '#fff0c7', '--panel': 'rgba(22, 16, 24, 0.9)' },
      vishnulok: { '--amber': '#587bcd', '--gold': '#f5e5ae', '--panel': 'rgba(8, 14, 35, 0.9)' },
      kailash: { '--amber': '#63a9bf', '--gold': '#e8edf2', '--panel': 'rgba(12, 18, 29, 0.91)' },
    },
  },
  {
    id: 'vellum',
    ...
    universeVars: {
      ...
      brahmalok: { '--amber': '#c8a66b', '--gold': '#f5e6c2', '--panel': 'rgba(29, 24, 27, 0.88)' },
      vishnulok: { '--amber': '#8196b8', '--gold': '#eee2c2', '--panel': 'rgba(18, 24, 42, 0.88)' },
      kailash: { '--amber': '#7895a8', '--gold': '#e4e8eb', '--panel': 'rgba(25, 31, 40, 0.89)' },
    },
  },
  {
    id: 'voidglass',
    ...
    universeVars: {
      ...
      brahmalok: { '--amber': '#889fc5', '--gold': '#e1e6f4', '--panel': 'rgba(18, 18, 35, 0.9)' },
      vishnulok: { '--amber': '#6881c5', '--gold': '#e0dcce', '--panel': 'rgba(10, 17, 46, 0.9)' },
      kailash: { '--amber': '#6589b0', '--gold': '#dde4ef', '--panel': 'rgba(15, 24, 40, 0.9)' },
    },
  },
  {
    id: 'dawnforge',
    ...
    universeVars: {
      ...
      brahmalok: { '--amber': '#d58b58', '--gold': '#f7cf9f', '--panel': 'rgba(38, 22, 24, 0.9)' },
      vishnulok: { '--amber': '#b88667', '--gold': '#efd6ae', '--panel': 'rgba(34, 23, 35, 0.89)' },
      kailash: { '--amber': '#b8785a', '--gold': '#efd9ce', '--panel': 'rgba(35, 24, 29, 0.9)' },
    },
  },
  {
    id: 'aurora-archive',
    ...
    universeVars: {
      ...
      brahmalok: { '--amber': '#6ebfc2', '--gold': '#ddf6e8', '--panel': 'rgba(10, 27, 32, 0.9)' },
      vishnulok: { '--amber': '#5c9ea0', '--gold': '#e1ecd6', '--panel': 'rgba(7, 26, 39, 0.9)' },
      kailash: { '--amber': '#6aa9a1', '--gold': '#e3f1ed', '--panel': 'rgba(10, 27, 33, 0.9)' },
    },
  },
  {
    id: 'eclipse-gold',
    ...
    universeVars: {
      ...
      brahmalok: { '--amber': '#d2a044', '--gold': '#fff0b8', '--panel': 'rgba(24, 18, 20, 0.92)' },
      vishnulok: { '--amber': '#c29a4f', '--gold': '#f8e9b8', '--panel': 'rgba(16, 19, 31, 0.91)' },
      kailash: { '--amber': '#c47d4f', '--gold': '#f2ddc9', '--panel': 'rgba(26, 20, 23, 0.91)' },
    },
  },
  {
    id: 'chorusglass',
    ...
    universeVars: {
      ...
      brahmalok: { '--amber': '#c78cad', '--gold': '#f7e2df', '--panel': 'rgba(30, 18, 34, 0.91)' },
      vishnulok: { '--amber': '#9b88ba', '--gold': '#e9dfd4', '--panel': 'rgba(19, 17, 42, 0.9)' },
      kailash: { '--amber': '#8a82a9', '--gold': '#e8e2ee', '--panel': 'rgba(22, 20, 37, 0.91)' },
    },
  },
]
