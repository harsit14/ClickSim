...
import { BRAHMALOK, BRAHMALOK_V2_PACK } from './brahmalok'
import { VISHNULOK, VISHNULOK_V2_PACK } from './vishnulok'
import { KAILASH, KAILASH_V2_PACK } from './kailash'
...
export const UNIVERSES = [EMBERLIGHT, TIDEFALL, VERDANCE, CLOCKWORK, BRAHMALOK, VISHNULOK, KAILASH]
...
export const V2_UNIVERSE_BY_ID: ReadonlyMap<UniverseId, UniversePackV2> = new Map([
  ...
  ['brahmalok', BRAHMALOK_V2_PACK],
  ['vishnulok', VISHNULOK_V2_PACK],
  ['kailash', KAILASH_V2_PACK],
])
