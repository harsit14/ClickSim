...
export const BRAHMALOK_SPEC: FutureUniverseSpec = {
  ...
  story: [
    story('A Passage, Not a World', 'written across the first outer petal', 'Clockwork’s final interval uncovered a passage beneath its failed forecasts. The Wayfinder still expected ruins, economies, and a final machine. Brahmalok answers with none of them. The realm was already alive with making before our map found it. Its first instruction is a boundary: approach what is here; do not call restoration what would merely make it resemble you.'),
