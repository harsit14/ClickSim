...
export const KAILASH_SPEC: FutureUniverseSpec = {
  ...
  story: [
    ...
    story('Consent at the Still Point', 'release protocol around an incomplete copper ring', 'The player may inspect what returns, what remains, and what is retained before holding to consent. Releasing early cancels cleanly. The world recedes beat by beat with captions, reduced-motion equivalence, and no white flash.'),
