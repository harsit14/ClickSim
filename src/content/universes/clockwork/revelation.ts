...
export const CLOCKWORK_REVELATION_BEATS: readonly ClockworkRevelationBeat[] = [
  ...
  },
  {
    ...
    accessibleDescription: 'Older archive traces reveal three routes to places that already exist: Brahmalok, Vishnulok, and Kailash.',
  ...
  },
  {
    ...
    accessibleDescription: 'Clockwork resumes as the final restored universe. The three pre-existing lokas remain available as places the archive discovered and players may approach, not own.',
    revealsRealms: DIVINE_REALMS.map(({ id }) => id),
  },
] as const
