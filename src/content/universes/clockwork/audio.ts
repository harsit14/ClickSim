...
export const CLOCKWORK_AUDIO: UniverseAudioDef = {
  ...
  stems: [
    { id: 'u4-stem-escapement', kindlingFamily: 'u4-tooth-through-u4-flywheel', bus: 'music', description: 'Dry escapement, ceramic bearing, and low tuned-metal intervals establish the first train.' },
    { id: 'u4-stem-governor', kindlingFamily: 'u4-governor-through-u4-difference-engine', bus: 'music', description: 'Governor weights and relay clicks enter only when their train completes a cycle.' },
    { id: 'u4-stem-city', kindlingFamily: 'u4-relay-foundry-through-u4-city-of-hours', bus: 'music', description: 'Public bells and punched-paper rhythm assemble the machine into a city.' },
    { id: 'u4-stem-causal', kindlingFamily: 'u4-causal-engine-through-u4-great-regulator', bus: 'music', description: 'Tuned steel and gradually humanized timing reveal the protected exception in the plan.' },
  ],
