...
function kindlingObject(spec: ClockworkKindlingSpec): WorldObjectManifest {
  ...
  return {
    ...
    overlapGroup: `clockwork-kindling-${spec.zone}`,
    canOverlapWith: ['clockwork-route-lines'],
...
function patentObject(index: number): WorldObjectManifest {
  ...
  return {
    ...
    overlapGroup: 'clockwork-patent-ledger',
    canOverlapWith: [],
...
function signalObject(index: number): WorldObjectManifest {
  ...
  return {
    id: `clockwork-object-signal-${signal.id}`,
    sourceKind: 'omen',
    sourceId: signal.id,
    ...
    overlapGroup: 'clockwork-maintenance-signals',
    canOverlapWith: [],
    minimumHeartDistance: 1.4,
...
export const CLOCKWORK_BEACON_OBJECT: WorldObjectManifest = {
  id: 'clockwork-object-regulator-beacon',
  sourceKind: 'beacon',
  sourceId: 'clockwork-clockwork-beacon',
...
export const CLOCKWORK_BEACON: BeaconDef = {
  id: 'clockwork-clockwork-beacon',
  canonicalName: 'Beacon',
  localName: 'The Continuing Interval',
  requirement: {
    sourceKind: 'generator',
    sourceId: 'clockwork-great-regulator',
    target: 1,
