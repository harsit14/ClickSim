...
export const TIDEFALL_SET_PIECES: readonly TidefallSetPiece[] = [
  { id: 'first-current', name: 'The First Current', stages: [
    stage('tide-kindling-droplet', 'tidefall-droplet', 'Droplet', 'kindle',
    ...
    stage('tide-kindling-ripple', 'tidefall-ripple', 'Ripple', 'draw',
  ...
  { id: 'memory-littoral', name: 'The Memory Littoral', stages: [
    stage('tide-kindling-tidepool', 'tidefall-tidepool', 'Tidepool', 'build',
    ...
    stage('tide-kindling-current', 'tidefall-current', 'Current', 'draw',
  ...
  { id: 'reef-causeway', name: 'The Reef Causeway', stages: [
    stage('tide-kindling-reef-light', 'tidefall-reef-light', 'Reef Light', 'build',
    ...
    stage('tide-kindling-moonwake', 'tidefall-moonwake', 'Moonwake', 'draw',
  ...
  { id: 'nacre-cathedral', name: 'The Nacre Cathedral', stages: [
    stage('tide-kindling-kelp-cathedral', 'tidefall-kelp-cathedral', 'Kelp Cathedral', 'build',
    ...
    stage('tide-kindling-pearl-seed', 'tidefall-pearl-seed', 'Pearl Seed', 'condense',
  ...
  { id: 'keeper-meridian', name: 'The Keeper Meridian', stages: [
    stage('tide-kindling-bioluminance', 'tidefall-bioluminance', 'Bioluminance', 'kindle',
    ...
    stage('tide-kindling-drowned-beacon', 'tidefall-drowned-beacon', 'Drowned Beacon', 'build',
  ...
  { id: 'pelagic-census', name: 'The Pelagic Census', stages: [
    stage('tide-kindling-twin-tides', 'tidefall-twin-tides', 'Twin Tides', 'condense',
    ...
    stage('tide-kindling-shoal-constellation', 'tidefall-shoal-constellation', 'Shoal Constellation', 'draw',
  ...
  { id: 'living-trench', name: 'The Living Trench', stages: [
    stage('tide-kindling-abyssal-garden', 'tidefall-abyssal-garden', 'Abyssal Garden', 'build',
    ...
    stage('tide-kindling-living-sea', 'tidefall-living-sea', 'The Living Sea', 'condense',
  ...
  { id: 'world-circulation', name: 'The World Circulation', stages: [
    stage('tide-kindling-ocean-of-moons', 'tidefall-ocean-of-moons', 'Ocean of Moons', 'condense',
    ...
    stage('tide-kindling-world-current', 'tidefall-world-current', 'World Current', 'draw',
  ...
  { id: 'answering-depth', name: 'The Answering Depth', stages: [
    stage('tide-kindling-deep-trench', 'tidefall-deep-trench', 'The Deep Trench', 'build',
    ...
    stage('tide-kindling-second-wave', 'tidefall-second-wave', 'The Second Wave', 'condense',
