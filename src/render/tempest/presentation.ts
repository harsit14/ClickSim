...
export const TEMPEST_PRESENTATION = createAuthoredLokaPresentation(TEMPEST_V2_PACK, {
  ...
  heartPattern: 'segmented charge rings, numbered shelter notches, and a return line around an unoccupied refuge',
