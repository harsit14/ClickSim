...
export const CLOCKWORK_PATENT_MARKS: readonly ClockworkPatentMark[] = [
  {
    id: 'u4-patent-one-tooth-prototype', family: 'transmission', label: 'one tooth on a drive shaft',
    diagramPath: 'M8 25H32M14 29H28M18 25V14H24V25M16 14H26',
    accentPath: 'M9 20H15M12 17L15 20L12 23',
  },
  {
    id: 'u4-patent-self-oiling-bearing', family: 'transmission', label: 'sealed bearing and oil drop',
  ...
  {
    id: 'u4-patent-impossible-escapement', family: 'transmission', label: 'escapement with a missing input',
  ...
  {
    id: 'u4-patent-moonless-orrery', family: 'transmission', label: 'orrery turning around an empty axle',
  ...
  {
    id: 'u4-patent-memory-cam', family: 'prediction', label: 'eccentric memory cam and follower',
  ...
  {
    id: 'u4-patent-compassion-governor', family: 'prediction', label: 'governor arms held below overload',
  ...
  {
    id: 'u4-patent-punched-prophecy', family: 'prediction', label: 'punched forecast tape',
  ...
  {
    id: 'u4-patent-perpetual-warranty', family: 'prediction', label: 'perpetual warranty seal',
  ...
  {
    id: 'u4-patent-broken-hourglass', family: 'exception', label: 'hourglass with one uncounted grain',
  ...
  {
    id: 'u4-patent-clockmakers-hand', family: 'exception', label: 'articulated clockmaker hand',
  ...
  {
    id: 'u4-patent-city-shift-bell', family: 'exception', label: 'civic bell outside the machine schedule',
  ...
  {
    id: 'u4-patent-blueprint-tomorrow', family: 'exception', label: 'blueprint with one route left blank',
