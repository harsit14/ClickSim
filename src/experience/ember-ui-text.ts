...
const COPY: Readonly<Record<string, string>> = {
  ...
  'goal-lens.routes-label': 'Useful routes',
  'goal-lens.current-pace': 'Current pace',
  'goal-lens.rate-trend.faster': 'Faster than five minutes ago.',
  'goal-lens.rate-trend.steady': 'Same pace as five minutes ago.',
  'goal-lens.rate-trend.slower': 'Slower than five minutes ago.',
  'goal-lens.rate-trend.measuring': 'Measuring a five-minute baseline.',
  'goal-lens.progress-label': '{current} of {target} saved toward this goal',
  ...
  'reset.result.singularities-and-starting-kindlings': 'World and Epoch progress return; Singularities, Deep history, the Between, and other realms remain.',
  'reset.result.active-universe-opening-with-memory-multiplier': 'Only the active realm begins again. Other realms, preferences, the Archive, the Between, and the permanent record remain; all production doubles.',
  ...
  'reset.category.other-parked-universe-runs': 'Other parked realm runs',
