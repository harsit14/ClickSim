...
const COPY: Readonly<Record<string, string>> = {
  ...
  'reset-comparison.eyebrow.deep-collapse': 'Before the Deep Collapse',
  'reset-comparison.eyebrow.remembrance': 'Before Remembrance',
  'reset.action.cancel': 'Keep this era',
  'reset.action.confirm': 'Confirm {action}',
  'reset.action.epoch-turn': 'Supernova',
  'reset.action.deep-collapse': 'Deep Collapse',
  'reset.action.remembrance': 'Remembrance',
  ...
  'reset.result.singularities-and-starting-kindlings': 'World and Epoch progress return; Singularities, Deep history, the Between, and other universes remain.',
  'reset.result.active-universe-opening-with-memory-multiplier': 'Only the active universe begins again. Other universes, preferences, the Archive, the Between, and the permanent record remain; all production doubles.',
  ...
  'reset.category.trial-return-snapshot': 'Saved pre-trial run',
  ...
  'reset.category.epoch-turn-count': 'Epoch turn count',
  'reset.category.deep-currency': 'Singularities (Deep currency)',
  'reset.category.deep-laws': 'Deep laws',
  'reset.category.deep-works': 'Deep works',
  ...
  'reset.category.local-automation': 'Local automation',
  'reset.category.local-story-seen-sequence': 'Local story sequence',
  'reset.category.local-records': 'Local records',
  'reset.category.current-answer': 'Current answer',
  'reset.category.deep-collapse-count': 'Deep collapse count',
  'reset.category.progressive-ui': 'Purchased interface',
  ...
  'reset.category.playtime-and-all-world-earnings': 'Playtime and all-world earnings',
  'reset.category.historical-answers': 'Historical answers',
  'reset.category.remembrance-count': 'Remembrance count',
  'reset.category.chronicle': 'Chronicle',
  'reset.category.garden': 'Garden',
  'reset.category.atlas-unlocks': 'Atlas unlocks',
  'reset.category.other-parked-universe-runs': 'Other parked universe runs',
  'reset.category.atlas-route-state': 'Current Atlas route',
  'reset.category.atlas-route-record': 'Atlas route record',
  'reset.category.external-export': 'External save export',
